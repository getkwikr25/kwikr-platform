...
app.get('/api/popular-categories', async (c) => {
  try {
    ...
    // Get active job categories with their icons
                            ...
                            <div class="bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow duration-300 p-6">
                                <div class="flex items-start space-x-4">
                                    ${provider.image ? 
                                      ...
                                      `<div class="w-20 h-20 rounded-full bg-gradient-to-br ${getAvatarColor(provider.initials)} flex items-center justify-center text-white text-xl font-bold">${provider.initials}</div>`
                                    }
                                    <div class="flex-1">
                                        <div class="flex items-center justify-between mb-2">
                                            ...
                                            <div class="text-right">
                                                <div class="text-2xl font-bold text-kwikr-green">$${provider.rate}/hr</div>
                                        ...
                                        <p class="text-gray-600 text-sm mb-4">${provider.bio}</p>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="/#services" class="text-gray-700 hover:text-kwikr-green">Find Services</a>
  ...
  return c.html(`
    ...
    <body class="bg-white font-sans">
                        ...
                        <form id="searchForm" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select id="serviceTypeMain" class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-kwikr-green focus:ring-0 text-gray-800 bg-white">
                                        <option value="Cleaning Services">Cleaning Services</option>
                                        <option value="Plumbers">Plumbers</option>
                                        <option value="Carpenters">Carpenters</option>
                                        <option value="Electricians">Electricians</option>
        ...
        <script>
          ...
          // Billing Toggle for Subscription Plans
          let isAnnual = false;
          ...
          // Load service categories when page loads
          document.addEventListener('DOMContentLoaded', function() {
