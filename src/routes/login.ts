            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="/signup" class="text-gray-700 hover:text-kwikr-green">Sign Up</a>
                    </div>
                </div>
            </div>
        </nav>
            ...
            <div class="max-w-md w-full space-y-8 bg-white rounded-lg shadow-md p-8">
                <div>
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-gray-600">Sign in to your Kwikr account</p>
                    </div>
                </div>
                ...
                <div class="text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="/signup" class="font-medium text-kwikr-green hover:text-green-600">Sign up here</a>
                    </p>
                </div>
            </div>
        </div>
