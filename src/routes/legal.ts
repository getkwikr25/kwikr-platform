...
legalRoutes.get('/terms', async (c) => {
  return c.html(`
    ...
    <head>
        ...
        <title>Terms of Service - Kwikr</title>
        ...
        <div class="max-w-4xl mx-auto px-4 py-12">
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="prose max-w-none">
                    ...
                    <p class="mb-6">By accessing and using Kwikr, you accept and agree to be bound by the terms and provision of this agreement.</p>
                    
                    <h2 class="text-2xl font-semibold mb-4">2. Service Description</h2>
                    <p class="mb-6">Kwikr is a platform that connects clients with service providers across Canada. We facilitate connections but do not directly provide services.</p>
                    ...
                    <p class="mb-6">Kwikr acts as a platform facilitator. We are not liable for the quality, safety, or legality of services provided by third-party service providers.</p>
...
legalRoutes.get('/privacy', async (c) => {
  return c.html(`
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Privacy Policy - Kwikr</title>
        <script src="https://cdn.tailwindcss.com"></script>
        <script>
          tailwind.config = {
            theme: {
