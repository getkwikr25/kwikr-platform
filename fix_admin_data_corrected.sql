-- Add sample admin data with correct column names
...
-- Insert sample admin users (using correct column name: admin_role_id)
...
-- Insert sample moderation queue items (using correct column names)
...
-- Check if admin_activities table exists and has the right structure
-- Add sample admin activities if the table exists
INSERT OR IGNORE INTO admin_activities (admin_user_id, action_type, entity_type, entity_id, description, ip_address, user_agent) VALUES
