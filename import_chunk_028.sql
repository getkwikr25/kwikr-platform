...
INSERT INTO worker_profiles_new (
  ...
  profile_photo, category, subscription_type, user_id, website,
  hours_of_operation, hourly_rate, price_range, services_provided
  'L''Économie en Plancher Bois Franc',
  '<p>L''Économie en Plancher Bois Franc serves Québec City, Quebec, as a reliable flooring contractor with over 20 years of experience. The company specializes in a wide range of flooring options, including floating floors, cork floors, hardwood floors, and engineered floors. This diverse selection meets various aesthetic and functional needs for residential and commercial spaces.</p> <p>With a commitment to quality and customer satisfaction, L''Économie en Plancher Bois Franc ensures that each project is handled with care and professionalism. The team understands the importance of durable and attractive flooring, making it a priority to offer products that enhance the beauty and functionality of any space. The extensive experience in the industry allows for expert guidance in selecting the right flooring solutions tailored to individual preferences and requirements.</p> <p>Located at 2252 Bd Bastien, L''Économie en Plancher Bois Franc has built a strong reputation in the local community. The business values transparency and integrity, providing clients with clear information about their options and processes. This approach fosters trust and long-lasting relationships with customers.</p> <p>L''Économie en Plancher Bois Franc excels in delivering high-quality flooring solutions that cater to various needs. With a focus on customer service and product excellence, the company remains a top choice for those seeking flooring services in Québec City. Reach out to L''Économie en Plancher Bois Franc for outstanding flooring options in Québec City.</p>',
  '2252 Bd Bastien',
  'Canada',
  'QC',
  'Québec City',
  'G2B 1B6',
  'commandescpmdoyon@flordeco.ca',
  'canada/québec-city/home-services/l-économie-en-plancher-bois-franc',
  'ChIJSRFc9J2iuEwRxLdDp8wmZ00',
  46.8585691,
  -71.337997,
  '14188477678',
  'https://www.kwikr.ca/pictures/profile/pimage-327.jpg',
  'Flooring',
  'Growth Plan',
  343,
  'http://www.economieplancherboisfranc.ca/',
  NULL,
  NULL,
  NULL,
  NULL
...
INSERT INTO worker_profiles_new (
  ...
  profile_photo, category, subscription_type, user_id, website,
  hours_of_operation, hourly_rate, price_range, services_provided
  'A-West Floor Coverings',
  '<p>A-West Floor Coverings operates as a leading flooring contractor in Edmonton, Alberta, since 1978. This company specializes in both commercial and residential flooring solutions, offering a comprehensive range of products including carpet, linoleum, ceramic tiles, laminate, hardwood, and vinyl rubber baseboards. A-West Floor Coverings prides itself on its competitive pricing and commitment to excellence across all projects, regardless of size.</p><p>The company’s extensive experience allows it to effectively handle various flooring applications. Skilled staff and technicians prepare surfaces ranging from wood to foam-crete and concrete, ensuring a high-quality finish. A-West Floor Coverings collaborates with numerous manufacturers and distributors, providing access to a wide selection of flooring materials. The large showroom and warehouse area showcases an array of products, making it easy for customers to find the perfect flooring solution for their needs.</p><p>A-West Floor Coverings has built a solid reputation in Edmonton for its dedication to customer satisfaction and quality workmanship. The company’s long history reflects its ability to adapt and thrive in the flooring industry. Clients can expect professional service and expert advice tailored to their specific requirements.</p><p>With a focus on both residential and commercial projects, A-West Floor Coverings continues to deliver exceptional flooring solutions. This business combines experience, quality products, and competitive pricing to meet diverse flooring needs. Visit A-West Floor Coverings at 10584 107 St NW, Edmonton, Alberta, for all flooring requirements.</p>',
  '10584 107 St NW',
  'Canada',
  'AB',
  'Edmonton',
  'T5H 2Y6',
  'jenkinsbrandon@jenkinsflooring.com',
  'canada/edmonton/home-services/a-west-floor-coverings',
  'ChIJX4UEAksioFMRdfadTFRCpcA',
  53.54971,
  -113.5051076,
  '17804286524',
  'https://www.kwikr.ca/pictures/profile/pimage-317.jpg',
  'Flooring',
  'Growth Plan',
  333,
  'http://awestfloorcoverings.com/',
  NULL,
  NULL,
  NULL,
  NULL
...
INSERT INTO worker_profiles_new (
  ...
  profile_photo, category, subscription_type, user_id, website,
  hours_of_operation, hourly_rate, price_range, services_provided
  'Concrete Your Way Inc',
  '<p>Concrete Your Way Inc serves Concord, Ontario, as a leading flooring contractor specializing in concrete polishing, floor repair, and epoxy coating applications. With over 15 years of experience, the company caters to both residential and commercial clients, including general contractors and builders. The expertise in concrete solutions ensures that every space, whether an office, retail area, kitchen, or basement, receives tailored treatment.</p><p>Concrete Your Way Inc focuses on delivering quality results through a commitment to customer satisfaction. The skilled team assesses each project to propose the best solutions for any concrete flooring needs. The company’s extensive knowledge and hands-on experience allow them to tackle diverse challenges effectively. Free, upfront estimates provide transparency and build trust with clients.</p><p>High standards of workmanship and attention to detail characterize every project undertaken. The application of epoxy coatings enhances durability, making it suitable for various environments. Concrete Your Way Inc stands behind its work with a warranty on every completed project, reinforcing its dedication to quality and reliability.</p><p>Concrete Your Way Inc excels in providing concrete polishing, repair, and coating services in Concord. The combination of experience, quality results, and customer-focused service positions the company as a trusted partner in flooring solutions. Reach out to Concrete Your Way Inc for exceptional flooring services in Concord, Ontario.</p>',
  '112 Basaltic Rd #9',
  'Canada',
  'ON',
  'Concord',
  'L4K 1G6',
  'hello@localflooringgroup.com',
  'canada/concord/home-services/concrete-your-way-inc',
  'ChIJs3kYfyUsK4gRZ2KKqS_-5l0',
  43.8227806,
  -79.4981266,
  '14165649754',
  'https://www.kwikr.ca/pictures/profile/pimage-311.jpg',
  'Flooring',
  'Growth Plan',
  327,
  'https://concreteyourway.com/',
  NULL,
  NULL,
  NULL,
  NULL
